...
;(function (global) {
  ...
  var update = function updater() {
    var appButtons = Array.from(document.querySelectorAll('.webapps .title button'));
    var siteButtons = Array.from(document.querySelectorAll('.websites .title button'));
